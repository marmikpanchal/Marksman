            ...
            <div id="content-wrapper">
                <div class="container-fluid">
                        ...
                        <div class="card-header">
                            ...
                            <div class="nav-item dropdown" style="float:right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="pagesDropdown" :key="index">
                                    ...
                                    <a class="dropdown-item" v-on:click="deleteAssessment(assessment)">Delete</a>
                                </div>
                            </div> 
                        </div>
                        <div class="card-body">
                    ...
                    <b-modal ref="Assess_Delete_Modal" hide-footer title="Delete Assessment">
                        ...
                        <b-btn class = "mt-3" variant="success"  v-on:click="deleteAssessment(assessment)">Yes, delete it</b-btn>
                    </b-modal>
                </div>
            </div>
            <!-- End dashboard -->
